...
class KtRecver(threading.Thread):
    ...
    def run(self):
        ...
        self.kt.aCmdTemplates = self.builder.dCmdTplGrp['DEL_IMSI']
...
class Builder(object):
    ...
    def loadCmd(self):
        self.loadDispImsiCmd()
        self.loadDelImsiCmd()

    def loadDispImsiCmd(self):
        logging.info('loading disp imsi cmd template')
        tplName = 'DISP_IMSI'
        aCmdTmpl = []
        tmplCmd = {}
        tmplCmd['PS_ID'] = '22222222'
        tmplCmd['REGION_CODE'] = '100'
        tmplCmd['BILL_ID'] = '100'
        tmplCmd['SUB_BILL_ID'] = '100'
        tmplCmd['PS_SERVICE_TYPE'] = 'HLR'
        tmplCmd['ACTION_ID'] = '1'
    ...
    def loadDelImsiCmd(self):
        logging.info('loading delete imsi cmd template')
        tplName = 'DEL_IMSI'
        aCmdTmpl = []
        tmplCmd = {}
        tmplCmd['PS_ID'] = '33333333'
        tmplCmd['REGION_CODE'] = '100'
        tmplCmd['BILL_ID'] = '100'
        tmplCmd['SUB_BILL_ID'] = '100'
        tmplCmd['PS_SERVICE_TYPE'] = 'HLR'
